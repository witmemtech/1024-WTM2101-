...
int jtaglink_wait_handshake(jtaglink_handle_t* inst)
{
    ...
    printf("jtaglink_wait_handshake return 1\r\n");
    return 1;
}
...
int jtaglink_recv_file_data(DenoiseState *st, jtaglink_handle_t* inst)
{
    int	nr_bytes;
    int	count;
    ...
    //	data
    //
    //printf("DATALINK_MAX_PAYLOAD_LEN:%d\r\n",	DATALINK_MAX_PAYLOAD_LEN);
