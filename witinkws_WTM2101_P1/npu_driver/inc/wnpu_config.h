...
void wnpu_clear_sram_2(unsigned short addr, int len);
...
void wnpu_data_npu2soc(uint16_t regfile_addr, void* soc_mem_addr, uint32_t data_size);

void wnpu_data_soc2npu(void* soc_mem_addr, uint16_t regfile_addr, uint32_t data_size);
